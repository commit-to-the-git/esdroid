...
#endif
#ifndef PFNGLGETACTIVEUNIFORMBLOCKNAMEPROC
typedef void (GL_APIENTRYP PFNGLGETACTIVEUNIFORMBLOCKNAMEPROC)(GLuint,GLuint,GLsizei,GLsizei*,GLchar*);
#endif
#ifndef PFNGLUNIFORMBLOCKBINDINGPROC
typedef void (GL_APIENTRYP PFNGLUNIFORMBLOCKBINDINGPROC)(GLuint,GLuint,GLuint);
#endif
