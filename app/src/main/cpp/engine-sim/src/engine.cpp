...
void Engine::initialize(const Parameters &params) {
    ...
    #if defined(__ANDROID__)
    esdroid_wtflog("Engine::initialize: crankshaftCount=%d cylinderBankCount=%d cylinderCount=%d exhaustSystemCount=%d intakeCount=%d", m_crankshaftCount, m_cylinderBankCount, m_cylinderCount, m_exhaustSystemCount, m_intakeCount);
#endif
